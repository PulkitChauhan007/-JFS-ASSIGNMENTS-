...
class Account {
  ...
  const account1 = new SavingAccount(123847334,"Pulkit",60000,10000);
  const account2 = new CurrentAccount(1518600347, "Mujahid", 25000, 10000);
  const account3 = new SavingAccount(151860233, "Sukumar", 90000, 2000);
  const account4 = new CurrentAccount(151860323, "Shriya", 6000, 5000);
...
let employeeObj = new Employee("Pulkit Chauhan",7,"ANALYST");
