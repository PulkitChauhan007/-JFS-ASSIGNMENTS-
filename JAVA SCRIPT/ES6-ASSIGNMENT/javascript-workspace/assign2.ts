...
chatRoom1.set("user1", ["Hello","Kya Haal Hai?","Mai Theek Hu", "Thank you"]);
chatRoom1.set("user2", ["Hi","Kya Haal Hai?","Mai Theek Hu", "Thank you"]);
chatRoom1.set("user3", ["Hi","Kya Haal Hai?","Mai Theek Hu", "Thank you"]);
chatRoom2.set("user4", ["Hello","Kya Haal Hai?","Mai Theek Hu", "Thank you"]);
chatRoom2.set("user5", ["Hello","Kya Haal Hai?","Mai Theek Hu", "Thank you"]);
chatRoom2.set("user6", ["Hi","Kya Haal Hai?","Mai Theek Hu", "Thank you"]);
