...
//Q4 
var myObject = {firstname: "pulkit",lastname: "chauhan",age: "22",city: "Greater Noida",state: "Uttarpradesh",country: "India"};
...
myObject.MiddleName = "Darshini";
document.write(`After defining The middle name is : ${myObject.MiddleName}`);

//Q6 
var string = "{firstName:'shriya', age:22, city:'noida', state:'uttarpradesh', country:'India'}";
eval('var obj='+string);
document.write(obj);
myObject.MiddleName = "Singh";
document.write(` The middle name is : ${myObject.MiddleName}`);

//Q7 
var obj = '{ "firstName":"Pulkit", "lastName":"Chauhan" }';
