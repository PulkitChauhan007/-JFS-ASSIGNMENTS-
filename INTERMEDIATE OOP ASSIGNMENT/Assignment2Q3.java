...
public  class Assignment2Q3 {
    ...
    public static void main(String[] args) {
        ...
        totalCashInBank.add(acc1.deposit(200));
        totalCashInBank.add(acc2.deposit(4000));
        totalCashInBank.add(acc3.deposit(600));
        totalCashInBank.add(acc4.deposit(400));
        totalCashInBank.add(acc3.withdraw(500));
        totalCashInBank.add(acc2.withdraw(6300));
