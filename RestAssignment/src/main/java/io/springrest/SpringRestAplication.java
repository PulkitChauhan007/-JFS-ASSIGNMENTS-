...
public class SpringRestAplication{
	...
	{
		if(username.equals("Pulkit")&& password.equals("pullu"))
			return "Valid User";else return "Invalid User";
	}

	@GetMapping("/Q3/{Zipcode}")
	public ZipCode Q3(@PathVariable Integer Zipcode)   {
		ZipCode z = new ZipCode(201306, "Greater Noida", "Uttar Pradesh", "India");
