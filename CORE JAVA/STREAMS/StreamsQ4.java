...
public class StreamsQ4 {
    ...
    public static void main(String[] args) {
        Trader t1 = new Trader("shriya ", "Bangalore");
        Trader t2 = new Trader("pallavi ", "Pune");
        Trader t3 = new Trader("kitto ", "Bangalore");
        Trader t4 = new Trader("moto ", "Delhi");
        Trader t5= new Trader("sweety ", "Chennai");

        Trader t6 = new Trader("akriti ", "Pune");
        Trader t7 = new Trader("juhi ", "Delhi");
        Trader t8 = new Trader("sanam ", "Delhi");
        Trader t9 = new Trader("anshima ", "Pune");
