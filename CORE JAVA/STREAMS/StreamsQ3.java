...
public class StreamsQ3 {
    ...
    public static void main(String[] args) {
        Trader t1 = new Trader("Pulkit ", "Bangalore");
        Trader t2 = new Trader("shriya ", "Pune");
        Trader t3 = new Trader("tanvi ", "Bangalore");
        Trader t4 = new Trader("juhi ", "Delhi");
        Trader t5= new Trader("mahii ", "Chennai");

        Trader t6 = new Trader("dhoni ", "Pune");
        Trader t7 = new Trader("kalash ", "Delhi");
        Trader t8 = new Trader("Suraj ", "Delhi");
        Trader t9 = new Trader("laddi ", "Pune");
